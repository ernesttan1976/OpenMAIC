...
export function AgentBar() {
  ...
  return (
    <div ref={containerRef} className="relative w-[13.125rem] sm:w-[16.875rem] lg:w-[18rem]">
      <Tooltip>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-1 z-50 w-[13.125rem] sm:w-[16.875rem] lg:w-[18rem]"
          >
