...
export function AgentBar() {
  ...
  return (
    <div ref={containerRef} className="relative w-[10.5rem] sm:w-[13.5rem] lg:w-[18rem]">
      <Tooltip>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-1 z-50 w-[10.5rem] sm:w-[13.5rem] lg:w-[18rem]"
          >
