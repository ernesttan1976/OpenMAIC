...
export function AccountMenu({ user }: AccountMenuProps) {
  ...
  return (
    <HeaderActionPortal fallbackClassName="fixed top-4 right-4 z-[60]">
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <button
            type="button"
            className="order-2 flex size-10 items-center justify-center rounded-full border border-gray-100/70 bg-white/70 shadow-sm backdrop-blur-md transition-colors hover:bg-white dark:border-gray-700/70 dark:bg-gray-800/70 dark:hover:bg-gray-800"
